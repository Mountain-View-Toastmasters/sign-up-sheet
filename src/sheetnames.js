/**
 * This file just contains all the constants for the names of the
 * spreadsheets used within the scripts and in the main Sign-Up Sheet 
 * Google sheet.
 * 
 * If you want to test on copies of the sheets, you can edit these names.
 */
